...
> - If you get an error saying something like  assignment_2 already exists do the following
>	- `git checkout assignment_2`
> - Creating this feature groupings allow users to modify code without causing issues with the current functioning code.
> - Any modifications to these files after <b>branching</b> can be undone
> - "assignment_2" is the branch name.
...
> `git commit -m "mboutique Assignment_2 - Eric Johnson"`
...
>   1. If you set the commit message above you should get get <b>mboutique Assignment_2 - [you name first & last 
